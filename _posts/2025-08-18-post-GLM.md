...
As shown in ![Alt text](assets/images/GLM.png), in many applications the observation is **nonlinear**:
...
We **decouple** each GLM iteration into two modules A and B that pass **Gaussian extrinsic messages** for the latent linear output $\mathbf z$, as shown in Figure 1.
